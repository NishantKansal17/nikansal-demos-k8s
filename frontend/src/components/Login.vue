<template>
  ...
  <b-card 
    class="align-center"
    header-tag="header">
    <div slot="header" id="header-div" class="nav-background-repeat">
      <span style="vertical-align: middle"><img src="./../assets/img/cisco-logo.png" height="30em" alt="Cisco Systems" />Cloud Native Console</span>
    </div>
